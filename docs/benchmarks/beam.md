...
| 5 | [Forgetting and Memory Management](../capabilities/05-forgetting-and-memory-management.md) | ❌ None | No authored category tests pruning, retention budgets, non-contradictory staleness, or harmful over-retention. |
