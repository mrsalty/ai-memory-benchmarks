...
| 5 | [Forgetting and Memory Management](../capabilities/05-forgetting-and-memory-management.md) | ❌ None | The benchmark makes histories difficult with distractors, but no author-defined task or metric rewards a system for pruning, suppressing, or deprioritizing otherwise valid information. Update correctness is not selective forgetting. |
