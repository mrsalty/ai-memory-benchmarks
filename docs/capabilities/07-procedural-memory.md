...
**Definition**: previously stored workflows, instructions, or operating procedures are reused
correctly in a later interaction — e.g. following a previously agreed-upon format, convention,
or process without being re-told it.

**Motivation**: recurring collaboration (a coding convention, a preferred meeting format, a
...
**Why it matters**: if a system has to be re-told the same workflow every session, it isn't
providing the continuity that makes long-term memory valuable for repeated collaborative tasks.

**What kinds of benchmark tasks evaluate it**: recurring workflows, preferred meeting formats,
...
**What does not belong to this capability**: **substrate mismatch flag** — in human cognition,
...
**Typical failure modes**: correctly recalling the stated procedure when asked to describe it,
...
**Example benchmark questions**: a user specifies a preferred code review format in an early
...
**Relationship to other capabilities**: given the substrate mismatch above, this capability is
...
**Mapping to cognitive science**: non-declarative / skill / habit memory — but see the
substrate-mismatch flag above; the AI-benchmark version of this capability is not a faithful
analogue of the cog-sci concept it's named after.

**Notes about common ambiguities**: because of the substrate mismatch, this is one of the
